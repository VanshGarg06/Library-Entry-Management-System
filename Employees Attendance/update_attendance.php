...
$flag = 0;
$refnum = $_GET['ref'];
$selectquery = "select * from employee_attendance where id='$refnum'";
...
if(isset($_POST['submit_update1']))
{
    ...
    $sql = "update employee_attendance set date='$date',temp='$temp',tag='$tag',timeIn='$timein',timeOut='$timeout' where id=$ref_update";
...
?>
<meta http-equiv='refresh' content='10; url=http://localhost/Library%20Attendance/Employees%20Attendance/attendance.php'>
<?php
    }
    else{
...
<?php if($flag){ ?>
    <div class="success">
        <p>You have updated the attendance of employee successfully!</p>
    </div>
    <?php } ?>
    <main>
        <div class="container">
            <div class="heading">
                <h1 class="header">Edit Employee Attendance</h1>
                <button type="button" class="btn"><a href="../Employees Attendance/attendance.php">Back</a></button>
            </div>
            <div class="add-form">
                <form action="" method="post">
                    <h1 style="display:block;text-align:center;font-weight:bolder;font-size:18px;color:grey;"><?php echo "$refnum" ?></h1>
                    ...
                    <input type="submit" value="Edit Employee Attendance" class="add-btn" name="submit_update1">
                </form>
            </div>
        </div>
    </main>
