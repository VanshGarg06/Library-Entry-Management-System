...
<div class="data-table">
    <table style="height:400px;margin-top:20px;overflow:scroll;">
        ...
        <tbody>
            <?php
             $result = mysqli_query($conn,"select * from employee_attendance");
            ...
            <tr>
                ...
                update_attendance.php?ref=<?php echo $row['id'];?>&tarik=<?php echo $row['date'];?>&naam=<?php echo $row['name_employee'];?>&degree=<?php echo $row['temp'];?>&extra=<?php echo $row['tag'];?>&intime=<?php echo $row['timeIn'];?>&outtime=<?php echo $row['timeOut'];?>
                ">Edit</a>
...
<!-- <button type="button" style="background-color:palegreen;border:none;border-radius:10px;width:50px;height:50px;" class="edit_student"> -->